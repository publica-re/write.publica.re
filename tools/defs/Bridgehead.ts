      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "renderas",
  documentation: "Indicates how the bridge head should be rendered",
  
        
dataType: {
  type: "enum",
  values: ['sect1','sect2','sect3','sect4','sect5','other'],
},
      ...
      
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "otherrenderas",
  documentation: "Identifies the nature of the non-standard rendering",
