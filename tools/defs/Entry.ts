      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "morerows",
  documentation: "Specifies the number of additional rows which this entry occupies. Defaults to zero.",
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "rotate",
  documentation: "Specifies the rotation of this entry. A value of 1 (true) rotates the cell 90 degrees counter-clockwise. A value of 0 (false) leaves the cell unrotated.",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "colname",
  documentation: "Specifies a column specification by name.",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "namest",
  documentation: "Specifies a starting column by name.",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "nameend",
  documentation: "Specifies an ending column by name.",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "spanname",
  documentation: "Specifies a span by name.",
