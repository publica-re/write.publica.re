      ...
      
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "defaultlabel",
  documentation: "Specifies the default labelling",
  
        
dataType: {
  type: "enum",
  values: ['none','number','qanda'],
},
        ...
        
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "qandadiv",
  documentation: "A titled division in a qandaset",
  minOccurs: 1,
  maxOccurs: unbounded
},
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "qandaentry",
  documentation: "A question/answer set within a qandaset",
  minOccurs: 1,
  maxOccurs: unbounded
},
