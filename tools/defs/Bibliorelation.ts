...
dataType: {
  type: "enum",
  values: ['doi','isbn','isrn','issn','istc','libraryofcongress','pubsnumber','uri','other'],
},
...
dataType: {
  type: "enum",
  values: ['hasformat','haspart','hasversion','isformatof','ispartof','isreferencedby','isreplacedby','isrequiredby','isversionof','references','replaces','requires','other'],
},
          ...
          
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "othertype",
  documentation: "A keyword that identififes the type of the non-standard relationship",
