    ...
    
{
  ...
  localName: "revision",
  documentation: "An entry describing a single revision in the history of the revisions to a document",
  mixed: false,
  attributes: [
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "revnumber",
  documentation: "A document revision number",
  minOccurs: 0,
  maxOccurs: 1
},
        ...
        
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "revremark",
  documentation: "A description of a revision to a document",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "revdescription",
  documentation: "A extended description of a revision to a document",
  minOccurs: 1,
  maxOccurs: 1
},
