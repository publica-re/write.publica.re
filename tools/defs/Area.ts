    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "units",
  documentation: "The units (for example, pages) used to identify the beginning and ending of a reference.",
  
      
dataType: {
  type: "enum",
  values: ['calspair','linecolumn','linecolumnpair','linerange','other'],
},
    ...
    
{
  ...
  documentation: "Identifies the units used in the coords attribute when the units attribute is other . This attribute is forbidden otherwise.",
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "linkends",
  documentation: "Points to one or more internal link targets by identifying the value of their xml:id attributes",
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "coords",
  documentation: "Provides the coordinates of the area. The coordinates must be interpreted using the units specified.",
