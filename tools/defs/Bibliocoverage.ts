    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "spatial",
  documentation: "Specifies the type of spatial coverage",
  
      
dataType: {
  type: "enum",
  values: ['dcmipoint','iso3166','dcmibox','tgn','other'],
},
    ...
    
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "otherspatial",
  documentation: "A keyword that identifies the type of non-standard coverage",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "temporal",
  documentation: "Specifies the type of temporal coverage",
  
      
dataType: {
  type: "enum",
  values: ['dcmiperiod','w3c-dtf','other'],
},
