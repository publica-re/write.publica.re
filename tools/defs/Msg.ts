    ...
    
{
  ...
  localName: "msg",
  documentation: "A message in a message set",
  mixed: false,
  attributes: [
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "msgmain",
  documentation: "The primary component of a message in a message set",
  minOccurs: 1,
  maxOccurs: 1
},
        ...
        
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "msgsub",
  documentation: "A subcomponent of a message in a message set",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "msgrel",
  documentation: "A related component of a message in a message set",
  minOccurs: 1,
  maxOccurs: 1
},
