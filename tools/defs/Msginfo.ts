    ...
    
{
  ...
  localName: "msginfo",
  documentation: "Information about a message in a message set",
  mixed: false,
  attributes: [
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "msglevel",
  documentation: "The level of importance or severity of a message in a message set",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "msgorig",
  documentation: "The origin of a message in a message set",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "msgaud",
  documentation: "The audience to which a message in a message set is relevant",
  minOccurs: 1,
  maxOccurs: 1
},
