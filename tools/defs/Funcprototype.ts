    ...
    
{
  ...
  localName: "funcprototype",
  documentation: "The prototype of a function",
  mixed: false,
  attributes: [
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "funcdef",
  documentation: "A function (subroutine) name and its return type",
  minOccurs: 1,
  maxOccurs: 1
},
        ...
        
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "void",
  documentation: "An empty element in a function synopsis indicating that the function in question takes no arguments",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "varargs",
  documentation: "An empty element in a function synopsis indicating a variable number of arguments",
  minOccurs: 1,
  maxOccurs: 1
},
