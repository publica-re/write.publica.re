      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "columns",
  documentation: "Specifies the number of columns for horizontal or vertical presentation",
...
dataType: {
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "member",
  documentation: "An element of a simple list",
  minOccurs: 1,
  maxOccurs: unbounded
},
