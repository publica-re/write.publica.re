      ...
      
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "termlength",
  documentation: "Indicates a length beyond which the presentation system may consider a term too long and select an alternate presentation for that term, item, or list",
    ...
    
{
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "varlistentry",
  documentation: "A wrapper for a set of terms and the associated description in a variable list",
  minOccurs: 1,
  maxOccurs: unbounded
},
