    ...
    
{
  ...
  localName: "subject",
  documentation: "One of a group of terms describing the subject matter of a document",
  mixed: false,
  attributes: [
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "weight",
  documentation: "Specifies a ranking for this subject relative to other subjects in the same set",
  ...
  documentation: "A term in a group of terms describing the subject matter of a document",
  minOccurs: 1,
  maxOccurs: unbounded
},
