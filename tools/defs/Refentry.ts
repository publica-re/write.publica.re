      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "refmeta",
  documentation: "Meta-information for a reference entry",
  minOccurs: 0,
  maxOccurs: 1
},
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "refsynopsisdiv",
  documentation: "A syntactic synopsis of the subject of the reference page",
  minOccurs: 0,
  maxOccurs: 1
},
    ...
    
{
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "refsection",
  documentation: "A recursive section in a refentry",
  minOccurs: 1,
  maxOccurs: unbounded
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "refsect1",
  documentation: "A major subsection of a reference entry",
  minOccurs: 1,
  maxOccurs: unbounded
},
