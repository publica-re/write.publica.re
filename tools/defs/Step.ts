    ...
    
{
  ...
  localName: "step",
  documentation: "A unit of action in a procedure",
  mixed: false,
  attributes: [
    ...
    
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "performance",
  documentation: "Specifies if the content is required or optional.",
          ...
          
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "substeps",
  documentation: "A wrapper for steps that occur within steps in a procedure",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "stepalternatives",
  documentation: "Alternative steps in a procedure",
  minOccurs: 1,
  maxOccurs: 1
},
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "result",
  documentation: "A wrapper for identifying the results of a procedure or step",
  minOccurs: 0,
  maxOccurs: 1
},
