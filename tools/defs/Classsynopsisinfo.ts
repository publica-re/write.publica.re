    ...
    
{
  ...
  localName: "classsynopsisinfo",
  documentation: "Information supplementing the contents of a classsynopsis",
  mixed: true,
  attributes: [
      ...
      
{
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "lineannotation",
  documentation: "A comment on a line in a verbatim listing",
  minOccurs: 0,
  maxOccurs: unbounded
},
