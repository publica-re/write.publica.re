      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "action",
  documentation: "Identifies the nature of the action taken. If keycombo contains more than one element, simul is the default, otherwise there is no default.",
  
        
dataType: {
  type: "enum",
  values: ['click','double-click','press','seq','simul','other'],
},
      ...
      
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "otheraction",
  documentation: "Identifies the non-standard action in some unspecified way.",
