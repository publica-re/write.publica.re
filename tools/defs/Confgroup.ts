      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "confdates",
  documentation: "The dates of a conference for which a document was written",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "conftitle",
  documentation: "The title of a conference for which a document was written",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "confnum",
  documentation: "An identifier, frequently numerical, associated with a conference for which a document was written",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "confsponsor",
  documentation: "The sponsor of a conference for which a document was written",
  minOccurs: 1,
  maxOccurs: 1
},
