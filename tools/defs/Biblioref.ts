    ...
    
{
  ...
  localName: "biblioref",
  documentation: "A cross-reference to a bibliographic entry",
  mixed: false,
  attributes: [
  ...
  
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "xrefstyle",
  documentation: "Specifies a keyword or keywords identifying additional style information",
...
},
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "endterm",
  documentation: "Points to the element whose content is to be used as the text of the link",
...
},
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "begin",
  documentation: "Identifies the beginning of a reference; the location within the work that is being referenced.",
...
},
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "end",
  documentation: "Identifies the end of a reference.",
