...
},
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "colnum",
  documentation: "The number of the column to which this specification applies. Must be greater than any preceding column number. Defaults to one more than the number of the preceding column, if there is one, or one.",
...
},
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "colwidth",
  documentation: "Specifies the width of the column.",
