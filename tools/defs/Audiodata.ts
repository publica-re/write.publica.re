    ...
    
{
  ...
  localName: "audiodata",
  documentation: "Pointer to external audio data",
  mixed: false,
  attributes: [
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "format",
  documentation: "Specifies the format of the data",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "fileref",
  documentation: "Indentifies the location of the data by URI",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "entityref",
  documentation: "Identifies the location of the data by external identifier (entity name)",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "autoplay",
  documentation: "Specifies the autoplay setting for a media object player",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "classid",
  documentation: "Specifies a classid for a media object player",
    ...
    
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "contentwidth",
  documentation: "Specifies the width of the content rectangle",
    ...
    
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "contentdepth",
  documentation: "Specifies the depth of the content rectangle",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "depth",
  documentation: "Specifies the depth of the element",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "scale",
  documentation: "Specifies the scaling factor",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "scalefit",
  documentation: "Determines if anamorphic scaling is forbidden",
