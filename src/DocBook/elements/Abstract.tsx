...
export class Abstract extends Transformer.Template<AbstractProps, AbstractState> {
  constructor(
    props: AbstractProps & {
...
ctx.register(
  Abstract,
  { path:
    `*[namespace-uri()='${AbstractData.namespace}' and local-name()='${AbstractData.localName}']`
  }
);