export default {
  ...
  localName: "multimediaparam",
  documentation: "Application specific parameters for a media player",
  mixed: false,
  attributes: [
    {
      type: "attribute",
    ...
    },
    {
      ...
      namespace: "http://docbook.org/ns/docbook",
      localName: "valuetype",
      documentation: "Specifies the type of the value of the parameter",
    },
  ],
  elements: {},
};
