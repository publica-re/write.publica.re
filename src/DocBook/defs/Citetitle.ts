    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "pubwork",
  documentation: "Identifies the nature of the publication being cited",
  
      
dataType: {
  type: "enum",
  values: ['article','bbs','book','cdrom','chapter','dvd','emailmessage','gopher','journal','manuscript','newsposting','part','refentry','section','series','set','webpage','wiki'],
},
