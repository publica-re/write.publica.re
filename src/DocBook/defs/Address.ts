    ...
    
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "continuation",
  documentation: "Determines whether line numbering continues from the previous element or restarts.",
  
      
dataType: {
  type: "enum",
  values: ['continues','restart'],
},
    ...
    
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "linenumbering",
  documentation: "Determines whether lines are numbered.",
  
      
dataType: {
  type: "enum",
  values: ['numbered','unnumbered'],
},
    ...
    
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "startinglinenumber",
  documentation: "Specifies the initial line number.",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "language",
  documentation: "Identifies the language (i.e. programming language) of the verbatim content.",
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "pob",
  documentation: "A post office box in an address",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "street",
  documentation: "A street address in an address",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "city",
  documentation: "The name of a city in an address",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "state",
  documentation: "A state or province in an address",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "postcode",
  documentation: "A postal code in an address",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "otheraddr",
  documentation: "Uncategorized information in address",
  minOccurs: 1,
  maxOccurs: 1
},
