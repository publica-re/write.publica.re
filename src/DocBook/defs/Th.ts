    ...
    
{
  ...
  localName: "th",
  documentation: "A table header entry in an HTML table",
  mixed: false,
  attributes: [
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "abbr",
  documentation: "Provides an abbreviated form of the cell's content and may be rendered by user agents when appropriate in place of the cell's content. Abbreviated names should be short since user agents may render them repeatedly. For instance, speech synthesizers may render the abbreviated headers relating to a particular cell before rendering that cell's content.",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "headers",
  documentation: "Specifies the entry or entries which serve as headers for this element.",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "scope",
  documentation: "Specifies the scope of the index term",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "rowspan",
  documentation: "Specifies the number of rows spanned by the current cell. The default value of this attribute is one (1 ). The value zero (0 ) means that the cell spans all rows from the current row to the last row of the table section (thead , tbody , or tfoot ) in which the cell is defined.",
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "colspan",
  documentation: "Specifies the number of columns spanned by the current cell. The default value of this attribute is one (1 ). The value zero (0 ) means that the cell spans all columns from the current column to the last column of the column group (colgroup ) in which the cell is defined.",
