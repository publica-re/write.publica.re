    ...
    
{
  ...
  localName: "simplemsgentry",
  documentation: "A wrapper for a simpler entry in a message set",
  mixed: false,
  attributes: [
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "msgaud",
  documentation: "The audience to which the message relevant",
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "msgorig",
  documentation: "The origin of the message",
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "msglevel",
  documentation: "The level of importance or severity of a message",
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "msgtext",
  documentation: "The actual text of a message component in a message set",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "msgexplan",
  documentation: "Explanatory material relating to a message in a message set",
  minOccurs: 1,
  maxOccurs: unbounded
},
