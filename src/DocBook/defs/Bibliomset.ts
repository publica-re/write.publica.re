    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "relation",
  documentation: "Identifies the relationship between the bibliographic elemnts",
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "honorific",
  documentation: "The title of a person",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "firstname",
  documentation: "A given name of a person",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "givenname",
  documentation: "The given name of a person",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "surname",
  documentation: "An inherited or family name; in western cultures the last name",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "lineage",
  documentation: "The portion of a person's name indicating a relationship to ancestors",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "othername",
  documentation: "A component of a person's name that is not a first name, surname, or lineage",
  minOccurs: 1,
  maxOccurs: 1
},
