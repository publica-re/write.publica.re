    ...
    
{
  ...
  localName: "indexentry",
  documentation: "An entry in an index",
  mixed: false,
  attributes: [
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "primaryie",
  documentation: "A primary term in an index entry, not in the text",
  minOccurs: 0,
  maxOccurs: 1
},
        ...
        
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "seeie",
  documentation: "A See entry in an index, rather than in the text",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "seealsoie",
  documentation: "A See also entry in an index, rather than in the text",
  minOccurs: 1,
  maxOccurs: 1
},
        ...
        
{
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "secondaryie",
  documentation: "A secondary term in an index entry, rather than in the text",
  minOccurs: 1,
  maxOccurs: 1
},
          ...
          
{
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "tertiaryie",
  documentation: "A tertiary term in an index entry, rather than in the text",
  minOccurs: 1,
  maxOccurs: 1
},
