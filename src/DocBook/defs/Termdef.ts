    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "baseform",
  documentation: "Specifies the base form of the term, the one that appears in the glossary. This allows adjectival, plural, and other variations of the term to appear in the element. The element content is the default base form.",
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "sortas",
  documentation: "Specifies the string by which the element's content is to be sorted; if unspecified, the content is used",
