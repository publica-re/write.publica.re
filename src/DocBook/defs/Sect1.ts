    ...
    
{
  ...
  localName: "sect1",
  documentation: "A top-level section of document",
  mixed: false,
  attributes: [
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "sect2",
  documentation: "A subsection within a sect1",
  minOccurs: 1,
  maxOccurs: unbounded
},
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "simplesect",
  documentation: "A section of a document with no subdivisions",
  minOccurs: 0,
  maxOccurs: unbounded
},
