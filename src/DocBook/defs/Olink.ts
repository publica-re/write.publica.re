      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "localinfo",
  documentation: "Holds additional information that may be used by the application when resolving the link",
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "targetdoc",
  documentation: "Specifies the URI of the document in which the link target appears",
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "targetptr",
  documentation: "Specifies the location of the link target in the document",
