      ...
      
{
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "refentrytitle",
  documentation: "The title of a reference page",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "manvolnum",
  documentation: "A reference volume number",
  minOccurs: 0,
  maxOccurs: 1
},
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "refmiscinfo",
  documentation: "Meta-information for a reference entry other than the title and volume number",
  minOccurs: 0,
  maxOccurs: unbounded
},
