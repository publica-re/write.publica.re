    ...
    
{
  ...
  documentation: "A production in a set of EBNF productions",
  mixed: false,
  attributes: [
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "lhs",
  documentation: "The left-hand side of an EBNF production",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "rhs",
  documentation: "The right-hand side of an EBNF production",
  minOccurs: 1,
  maxOccurs: unbounded
},
  ...
  documentation: "A constraint in an EBNF production",
  minOccurs: 0,
  maxOccurs: unbounded
},
