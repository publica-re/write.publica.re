    ...
    
{
  ...
  localName: "refnamediv",
  documentation: "The name, purpose, and classification of a reference page",
  mixed: false,
  attributes: [
      ...
      
{
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "refdescriptor",
  documentation: "A description of the topic of a reference page",
  minOccurs: 0,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "refname",
  documentation: "The name of (one of) the subject(s) of a reference page",
  minOccurs: 1,
  maxOccurs: unbounded
},
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "refpurpose",
  documentation: "A short (one sentence) synopsis of the topic of a reference page",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "refclass",
  documentation: "The scope or other indication of applicability of a reference entry",
  minOccurs: 0,
  maxOccurs: unbounded
},
