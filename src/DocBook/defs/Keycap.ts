          ...
          
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "function",
  documentation: "Identifies the function key",
  
            
dataType: {
  type: "enum",
  values: ['alt','altgr','backspace','command','control','delete','down','end','enter','escape','home','insert','left','meta','option','pagedown','pageup','right','return','shift','space','tab','up','other'],
},
          ...
          
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "otherfunction",
  documentation: "Specifies a keyword that identifies the non-standard key",
