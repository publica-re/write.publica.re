...
dataType: {
  type: "enum",
  values: ['copyeditor','graphicdesigner','productioneditor','technicaleditor','translator','other','conversion','coverdesigner','illustrator','indexer','interiordesigner','proofreader','reviewer','typesetter'],
},
    ...
    
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "otherclass",
  documentation: "Identifies the nature of the non-standard bibliographic identifier",
      ...
      
{
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "personblurb",
  documentation: "A short description or note about a person",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  documentation: "The institutional affiliation of an individual",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "contrib",
  documentation: "A summary of the contributions made to a document by a credited source",
  minOccurs: 1,
  maxOccurs: 1
},
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "orgdiv",
  documentation: "A division of an organization",
  minOccurs: 1,
  maxOccurs: 1
},
