    ...
    
{
  ...
  localName: "glossentry",
  documentation: "An entry in a glossary or glosslist",
  mixed: false,
  attributes: [
        ...
        
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "glosssee",
  documentation: "A cross-reference from one glossentry to another",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "glossdef",
  documentation: "A definition in a glossentry",
  minOccurs: 1,
  maxOccurs: unbounded
},
