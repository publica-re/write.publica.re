    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "spacing",
  documentation: "Specifies (a hint about) the spacing of the content",
    ...
    
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "inheritnum",
  documentation: "Indicates whether or not item numbering should be influenced by list nesting",
  
      
dataType: {
  type: "enum",
  values: ['ignore','inherit'],
},
    ...
    
{
  type: "attribute",
  namespace: "http://docbook.org/ns/docbook",
  localName: "numeration",
  documentation: "Indicates the desired numeration",
  
      
dataType: {
  type: "enum",
  values: ['arabic','upperalpha','loweralpha','upperroman','lowerroman'],
},
    ...
    
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "listitem",
  documentation: "A wrapper for the elements of a list item",
  minOccurs: 1,
  maxOccurs: unbounded
},
