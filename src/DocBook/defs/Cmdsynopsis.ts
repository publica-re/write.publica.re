      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "sepchar",
  documentation: "Specifies the character that should separate the command and its top-level arguments",
      ...
      
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "cmdlength",
  documentation: "Indicates the displayed length of the command; this information may be used to intelligently indent command synopses which extend beyond one line",
        ...
        
{
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "arg",
  documentation: "An argument in a cmdsynopsis",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "group",
  documentation: "A group of elements in a cmdsynopsis",
  minOccurs: 1,
  maxOccurs: 1
},
  {
  ...
  namespace: "http://docbook.org/ns/docbook",
  localName: "sbr",
  documentation: "An explicit line break in a command synopsis",
  minOccurs: 1,
  maxOccurs: 1
},
  ...
  type: "element",
  namespace: "http://docbook.org/ns/docbook",
  localName: "synopfragment",
  documentation: "A portion of a cmdsynopsis broken out from the main body of the synopsis",
  minOccurs: 0,
  maxOccurs: unbounded
},
