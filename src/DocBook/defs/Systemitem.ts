...
dataType: {
  type: "enum",
  values: ['daemon','domainname','etheraddress','event','eventhandler','filesystem','fqdomainname','groupname','ipaddress','library','macro','netmask','newsgroup','osname','other','process','protocol','resource','securitycontext','server','service','systemname','username'],
},
